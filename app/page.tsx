  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="relative overflow-hidden px-6 py-24 md:py-32 lg:py-48 flex items-center justify-center border-b border-white/5">
          <div className="max-w-7xl mx-auto relative z-10 w-full">
            <div className="text-center space-y-8 max-w-5xl mx-auto">
              <div className="animate-fade-in-up">
                <Badge
                  variant="outline"
                  className="glass text-sm font-medium px-4 py-1.5 rounded-full border-primary/20 text-primary mb-6"
                >
                  Powered by Meta WhatsApp Cloud API
                </Badge>

                <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-display font-bold tracking-tight leading-[0.9] text-gradient">
                  Communication
                  <span className="text-primary block mt-2 drop-shadow-2xl">
                    Redefined.
                  </span>
                </h1>
              </div>

              <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed animate-fade-in-up delay-100 italic">
                The ultimate enterprise WhatsApp Business platform. Real-time, scalable, and stunningly beautiful.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8 animate-fade-in-up delay-200">
                <Link
                  href="/sign-up"
                  className="inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground hover:bg-primary/90 px-10 py-4 rounded-full font-bold transition-all shadow-2xl shadow-primary/40 hover:scale-105 active:scale-95"
                >
                ...
                <a
                  ...
                  className="glass inline-flex items-center justify-center gap-2 border-white/20 hover:bg-white/10 px-10 py-4 rounded-full font-bold transition-all"
                >
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-8 pt-16 max-w-3xl mx-auto text-sm font-medium text-muted-foreground/80">
                <div className="flex items-center justify-center gap-2 glass px-4 py-2 rounded-full border-white/5">
          ...
          {/* Hero Decorative Image Prompt */}
          {/* [IMAGE PROMPT START]  
          Cinematic wide photograph of a sleek, dark luxury tech workspace with 3D floating glass WhatsApp interface elements, vibrant green neon accents, hyper-realistic, volumetric lighting, 16:9 --ar 16:9 --v 6 --q 2 --stylize 650  
          [IMAGE PROMPT END] */}
        </section>
        ...
        <section id="features" className="py-20 md:py-28 px-6 bg-muted/30">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card className="glass p-6 hover:bg-white/10 transition-all duration-200 group border-white/5">
        ...
        <section className="py-20 md:py-28 px-6">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <Card className="glass p-6 text-center border-white/5 hover:bg-white/10 transition-all duration-200">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
              {[
                ...
                <Card
                  key={tech.name}
                  className="glass p-4 text-center hover:bg-white/10 transition-all duration-200 border-white/5"
                >
            ...
            <div className="grid sm:grid-cols-3 gap-4 mt-8">
              <Card className="glass p-5 text-center hover:bg-white/10 transition-all duration-200 border-white/5">
